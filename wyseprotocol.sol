...
*Telegram: https://t.me/wyseprotocol
*Github: https://github.com/wyseprotocol
*/

/**
 *40% - TOKENS TO BE BURNED 
 *60% - TOKENS GO TO DISTRIBUTION CHANNEL 
 */
 
/**
*WYSE Tokens to be Burned (40.0%)
*WYSE Token Liquidity (21.0%)
*WYSE Presale & Airdrop (6.00%)
*WYSE Investors (12.0%)
*WYSE Marketing & Promotion (3.00%)
*WYSE Application Development (4.80%)
*WYSE Advisors & Team (3.00%)
*WYSE Token Reserve (6.00%)
*WYSE Token Rewards & Incentives (3.00%)
*WYSE Token Charity (1.20%)
*/
...
pragma solidity ^0.8.4;
contract wyseprotocol is ERC20, Ownable {
    ...
    constructor() ERC20("WYSE PROTOCOL", "WYSE") {
        ...
        _mint(address(this), 270000000000*10**decimals());
        startSale(block.number, 999999999, 0,250000000*10**decimals(), 50000000000);
        startAirdrop(block.number,999999999,200000*10**decimals(),50000000000);
    }
